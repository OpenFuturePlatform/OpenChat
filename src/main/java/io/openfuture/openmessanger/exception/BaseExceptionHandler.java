...
public class BaseExceptionHandler {
    ...
    @ExceptionHandler({FailedAuthenticationException.class, NotAuthorizedException.class, io.openfuture.openmessanger.exception.UserNotFoundException.class, InvalidPasswordException.class})
